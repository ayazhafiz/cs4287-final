...
def get_requests_per_5_sec():
    requests_per_5_sec_interval = [0]
    ...
    with gzip.open("ita_public_tools/input/wc_day25_1.gz", "rb") as f:
        ...
        while f.readinto(request) == ctypes.sizeof(request):
            ...
            while ts - interval_start_timestamp > 5:
                interval_start_timestamp += 5
                yield requests_per_5_sec_interval[-1]
                requests_per_5_sec_interval.append(0)

            requests_per_5_sec_interval[-1] += 1
